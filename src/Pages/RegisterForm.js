  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow flex flex-col justify-center items-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-8 rounded-xl drop-shadow-2xl w-full max-w-2xl">
          <div className="mb-4">
            <img src={imagenRegistro} alt="Imagen de registro" className="w-full rounded-lg" />
          </div>

          <h2 className="text-3xl font-extrabold mb-5 text-sky-900">Crea tu cuenta gratis</h2>

          <div className="mb-4  ">
          <button type="button" className="w-48 py-1 mb-3 text-sky-900 font-bold border-2 border-sky-900 rounded-md ">
            <FontAwesomeIcon icon={faFacebookF} className="mr-2" />
            Facebook
          </button>
          <button type="button" className="w-48 py-1 ml-2 text-sky-900 font-bold border-2 border-sky-900 rounded-md ">
          ...
          <p className="mb-6">
            Si ya tienes una cuenta, <a href="#" className="text-blue-500">inicia sesión aquí.</a>
          </p>

          <div className="text-center mt-6">
            <button type="submit" className="w-80 py-2 bg-sky-900 text-white font-bold rounded-lg drop-shadow-2xl">Registrarme</button>
          </div>
        </form>
      </div>

      <footer className="mt-auto p-8 bg-sky-900 w-full">
